#!/usr/bin/env node
// ============================================================
// scripts/apply-music-general.mjs
// Musique : 3 pistes (general=map / combat / boss).
// general continue sans redémarrer entre map/village/victoire.
// ============================================================
...
const p = path.join(dir, 'src', 'core', 'music.js');
